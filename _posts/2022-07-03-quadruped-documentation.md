...
In the middle of trying to recftify the Wifi issue, I managed to SSH (Secure Shell) into the RPi from my laptop with the PuTTY terminal emulator. PuTTY is a tool I actually very recently learned about during my internship at Medtronic. SSH capability will allow me to access and modify RPi files from my laptop over an ethernet connection, circumventing the need to hook the RPi up to an dedicated display and keyboard setup.
