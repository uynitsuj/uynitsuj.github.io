...
To further minimize collisions from one to zero, further time could be spent from us to improve the flight parameters, or modifications could be made to improve sensors and actuators on the prototype. What is presented by the prototype is sufficient for a successful and efficient flight, but the client’s customers can explore physical and parameter improvements.
